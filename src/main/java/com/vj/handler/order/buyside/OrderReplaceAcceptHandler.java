...
public class OrderReplaceAcceptHandler extends ExecutionReportHandler {

    private static final Logger log = LoggerFactory.getLogger(OrderReplaceAcceptHandler.class);

    public OrderReplaceAcceptHandler(MessageTransform messageTransform) {

...
public class OrderCancelAcceptHandler extends ExecutionReportHandler {

    private static final Logger log = LoggerFactory.getLogger(OrderCancelAcceptHandler.class);

    public OrderCancelAcceptHandler(MessageTransform messageTransform) {

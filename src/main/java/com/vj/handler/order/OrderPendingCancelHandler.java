...
public class OrderPendingCancelHandler extends ExecutionReportHandler {


    public OrderPendingCancelHandler(EntityTransform entityTransform) {
    ...
    public boolean test(ExecutionReport executionReport, SessionID sessionID) {
        try {
            return executionReport.getExecType().getValue() == ExecType.PENDING_CANCEL;
